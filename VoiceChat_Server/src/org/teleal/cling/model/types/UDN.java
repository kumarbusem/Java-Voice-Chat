    ...
    public static UDN uniqueSystemIdentifier(String salt) {
        ...
        try {
            ...
            try {
                ...
                // Ignore, we did everything we can, catch Throwable  so we also
                // catch java.lang.NoSuchMethodError on Android because
                // NetworkInterface.isLoopback() is'nt implemented
            }
