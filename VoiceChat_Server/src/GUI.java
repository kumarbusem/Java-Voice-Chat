...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Boom Voice Server 1.0");

        jTextField1.setText("13440");
        ...
        log.setBackground(new java.awt.Color(157, 189, 255));
        log.setColumns(20);
        log.setRows(5);
        log.setBorder(null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Thread() { //start server in new thread
            ...
            public void run() {
                try {
                    new Server(Integer.parseInt(jTextField1.getText()),true);
                } catch (Exception ex) {
